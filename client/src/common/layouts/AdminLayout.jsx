...
const AdminLayout = () => {
  ...
  return (
    <div className="min-h-screen">
      <div className="grid grid-cols-12 gap- lg:max-w-full mx-auto">
        <div className="lg:col-span-2 col-span-12 bg-base-200 text-base-content sticky top-0 overflow-y-scroll lg:max-h-[calc(100vh-0px)] z-50">
