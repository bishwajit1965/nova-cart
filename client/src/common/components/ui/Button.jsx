...
const Button = ({
  ...
  const variants = {
    ...
    outline:
      "border border-base-content text-gray-800 hover:text-gray-800 bg-white bg-base-100 hover:bg-gray-300 shadow-md ring-2 ring-offset-2 ring-base-content ring-2 outline-2 shadow-md rounded-md",
