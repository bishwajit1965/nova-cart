  ...
  return (
    <div className="mt-6">
      <div className="lg:my-4 my-4 lg:p-4 p-4 border-b border-base-content/15 bg-base-300 rounded-t-xl">
        <h2 className="lg:text-2xl font-bold text-base-content/80 flex items-center gap-3">
          <BarChart3 /> Monthly & Weekly Revenue Analytics Combined
        </h2>
      </div>
      {/* Tabs */}
      <div className="flex space-x-4 mb-4 border-b border-base-content/20">
        <button
          className={`px-4 py-2 font-semibold ${
            activeTab === "weekly"
              ? "border-b-2 border-indigo-500 text-base-content/70"
